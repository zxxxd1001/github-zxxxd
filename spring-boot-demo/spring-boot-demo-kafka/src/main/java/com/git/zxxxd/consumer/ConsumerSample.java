package com.git.zxxxd.consumer;
...
//        commitOffset(props);
        // 手动对每个Partition进行提交
//        commitOffsetWithPartition(props);
        // 手动订阅某个或某些分区，并提交offset
//        commitOffsetWithPartition2(props);
...
//        controlPause(props);
    ...
    //工作里这种用法，有，但是不推荐
    private static void helloWorld(Properties props) {
    ...
    //手动提交offset
    private static void commitOffset(Properties props) {
    ...
    private static void commitOffsetWithPartition(Properties props) {
        props.setProperty("enable.auto.commit", "false");
    ...
    private static void commitOffsetWithPartition2(Properties props) {
        props.setProperty("enable.auto.commit", "false");
...
//        consumer.subscribe(Arrays.asList(TOPIC_NAME));
    ...
    //流量控制 - 限流
    private static void controlPause(Properties props) {
        props.setProperty("enable.auto.commit", "false");
