...
public class MyMap<K,V> {
    ...
    static final class TreeNode<K,V> extends Entry<K,V> {
        ...
        final TreeNode<K,V> putTreeVal(MyMap<K,V> map, Node<K,V>[] tab,
                                       int h, K k, V v) {
            Class<?> kc = null;
...
class P{
    ...
    public P(String name, Integer i) {
        this.name = name;
        this.i = i;
    }
